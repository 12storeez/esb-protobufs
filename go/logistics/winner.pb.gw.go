...
var (
	filter_WinnerService_Calculate_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_WinnerService_Calculate_0(ctx context.Context, marshaler runtime.Marshaler, client WinnerServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_WinnerService_Calculate_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterWinnerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server WinnerServiceServer) error {
	...
	mux.Handle("POST", pattern_WinnerService_Calculate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/logistics.WinnerService/Calculate", runtime.WithHTTPPathPattern("/api/v1/winner/calculate"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_WinnerService_Calculate_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_WinnerService_Calculate_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterWinnerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client WinnerServiceClient) error {
	...
	mux.Handle("POST", pattern_WinnerService_Calculate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/logistics.WinnerService/Calculate", runtime.WithHTTPPathPattern("/api/v1/winner/calculate"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_WinnerService_Calculate_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
