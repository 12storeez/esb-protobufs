...
var (
	filter_DeliveryMethodService_Suggest_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_DeliveryMethodService_Suggest_0(ctx context.Context, marshaler runtime.Marshaler, client DeliveryMethodServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SuggestDeliveryMethodRequest
	var metadata runtime.ServerMetadata

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_DeliveryMethodService_Suggest_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func local_request_DeliveryMethodService_Suggest_0(ctx context.Context, marshaler runtime.Marshaler, server DeliveryMethodServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SuggestDeliveryMethodRequest
	var metadata runtime.ServerMetadata
...
func RegisterDeliveryMethodServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DeliveryMethodServiceServer) error {
	...
	mux.Handle("GET", pattern_DeliveryMethodService_Suggest_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/logistics.DeliveryMethodService/Suggest", runtime.WithHTTPPathPattern("/api/v1/delivery-method/suggest"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DeliveryMethodService_Suggest_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_DeliveryMethodService_Suggest_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDeliveryMethodServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DeliveryMethodServiceClient) error {
	...
	mux.Handle("GET", pattern_DeliveryMethodService_Suggest_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/logistics.DeliveryMethodService/Suggest", runtime.WithHTTPPathPattern("/api/v1/delivery-method/suggest"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DeliveryMethodService_Suggest_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_DeliveryMethodService_Suggest_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "delivery-method", "suggest"}, ""))
)
...
var (
	...
	forward_DeliveryMethodService_Suggest_0 = runtime.ForwardResponseMessage
)
