...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x32,
	0x0a, 0x17, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73,
	0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72,
	0x49, 0x64, 0x22, 0xda, 0x01, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x41, 0x64,
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x91, 0x04, 0x0a, 0x0e, 0x47, 0x65, 0x74,
	...
	0x61, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x08, 0x48, 0x09, 0x52, 0x05, 0x69, 0x73, 0x42, 0x61,
	0x64, 0x88, 0x01, 0x01, 0x42, 0x0f, 0x0a, 0x0d, 0x5f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64,
	...
	0x66, 0x42, 0x09, 0x0a, 0x07, 0x5f, 0x69, 0x73, 0x5f, 0x62, 0x61, 0x64, 0x22, 0x5f, 0x0a, 0x0a,
	...
	0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x12, 0x19, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61,
	0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x48, 0x00, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c,
	0x88, 0x01, 0x01, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x2a, 0x24, 0x0a,
	...
	0x45, 0x10, 0x01, 0x32, 0xcf, 0x03, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x35, 0x0a, 0x06,
	...
	0x65, 0x22, 0x00, 0x12, 0x2c, 0x0a, 0x06, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x0a, 0x2e,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x09, 0x5a, 0x07, 0x67, 0x6f, 0x2f, 0x75, 0x73, 0x65, 0x72,
...
var file_proto_user_proto_goTypes = []interface{}{
	...
	(*GetUserAddressesRequest)(nil),  // 12: user.GetUserAddressesRequest
	(*GetUserAddressesResponse)(nil), // 13: user.GetUserAddressesResponse
	(*GetByTokenRequest)(nil),        // 14: user.GetByTokenRequest
	(*GetListRequest)(nil),           // 15: user.GetListRequest
	(*GetListResponse)(nil),          // 16: user.GetListResponse
	(*DeleteRequest)(nil),            // 17: user.DeleteRequest
	(*DeleteResponse)(nil),           // 18: user.DeleteResponse
	(*Error)(nil),                    // 19: user.Error
	(*GetListFilters)(nil),           // 20: user.GetListFilters
	(*Pagination)(nil),               // 21: user.Pagination
}
var file_proto_user_proto_depIdxs = []int32{
	19, // 0: user.MergeResponse.errors:type_name -> user.Error
	3,  // 1: user.MergeResponse.data:type_name -> user.MergeResponseData
	19, // 2: user.CreateResponse.errors:type_name -> user.Error
	6,  // 3: user.CreateResponse.data:type_name -> user.User
	8,  // 4: user.User.main_address:type_name -> user.Address
	19, // 5: user.UpdateResponse.errors:type_name -> user.Error
	6,  // 6: user.UpdateResponse.data:type_name -> user.User
	19, // 7: user.GetResponse.errors:type_name -> user.Error
	6,  // 8: user.GetResponse.data:type_name -> user.User
	19, // 9: user.GetUserAddressesResponse.errors:type_name -> user.Error
	8,  // 10: user.GetUserAddressesResponse.data:type_name -> user.Address
	21, // 11: user.GetUserAddressesResponse.pagination:type_name -> user.Pagination
	20, // 12: user.GetListRequest.filters:type_name -> user.GetListFilters
	21, // 13: user.GetListRequest.pagination:type_name -> user.Pagination
	19, // 14: user.GetListResponse.errors:type_name -> user.Error
	7,  // 15: user.GetListResponse.data:type_name -> user.UserShort
	21, // 16: user.GetListResponse.pagination:type_name -> user.Pagination
	19, // 17: user.DeleteResponse.errors:type_name -> user.Error
	0,  // 18: user.GetListFilters.type:type_name -> user.UserType
	4,  // 19: user.user.Create:input_type -> user.CreateRequest
	6,  // 20: user.user.Update:input_type -> user.User
	10, // 21: user.user.Get:input_type -> user.GetRequest
	14, // 22: user.user.GetByToken:input_type -> user.GetByTokenRequest
	15, // 23: user.user.GetList:input_type -> user.GetListRequest
	17, // 24: user.user.Delete:input_type -> user.DeleteRequest
	1,  // 25: user.user.Merge:input_type -> user.MergeRequest
	12, // 26: user.user.GetUserAddresses:input_type -> user.GetUserAddressesRequest
	5,  // 27: user.user.Create:output_type -> user.CreateResponse
	9,  // 28: user.user.Update:output_type -> user.UpdateResponse
	11, // 29: user.user.Get:output_type -> user.GetResponse
	11, // 30: user.user.GetByToken:output_type -> user.GetResponse
	16, // 31: user.user.GetList:output_type -> user.GetListResponse
	18, // 32: user.user.Delete:output_type -> user.DeleteResponse
	2,  // 33: user.user.Merge:output_type -> user.MergeResponse
	13, // 34: user.user.GetUserAddresses:output_type -> user.GetUserAddressesResponse
...
func file_proto_user_proto_init() {
	...
	file_proto_user_proto_msgTypes[19].OneofWrappers = []interface{}{}
