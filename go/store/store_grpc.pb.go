...
type StoreServiceClient interface {
	...
	GetByStoreCode(ctx context.Context, in *GetByStoreCodeRequest, opts ...grpc.CallOption) (*GetByStoreCodeResponse, error)
}
...
func (c *storeServiceClient) GetByStoreCode(ctx context.Context, in *GetByStoreCodeRequest, opts ...grpc.CallOption) (*GetByStoreCodeResponse, error) {
	out := new(GetByStoreCodeResponse)
...
type StoreServiceServer interface {
	...
	GetByStoreCode(context.Context, *GetByStoreCodeRequest) (*GetByStoreCodeResponse, error)
}
...
func (UnimplementedStoreServiceServer) GetByStoreCode(context.Context, *GetByStoreCodeRequest) (*GetByStoreCodeResponse, error) {
