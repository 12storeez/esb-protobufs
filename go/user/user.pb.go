...
func (x *MergeRequest) GetCountry() string {
...
type User struct {
	...
	Country      *string `protobuf:"bytes,18,opt,name=country,proto3,oneof" json:"country,omitempty"`
	...
	WmsId      *string `protobuf:"bytes,25,opt,name=wms_id,json=wmsId,proto3,oneof" json:"wms_id,omitempty"`
	// клиентские поля
	StoreCode                *int32     `protobuf:"varint,26,opt,name=store_code,json=storeCode,proto3,oneof" json:"store_code,omitempty"`
	RcrmId                   *int32     `protobuf:"varint,27,opt,name=rcrm_id,json=rcrmId,proto3,oneof" json:"rcrm_id,omitempty"`
	ClothingUpperSize        *string    `protobuf:"bytes,28,opt,name=clothing_upper_size,json=clothingUpperSize,proto3,oneof" json:"clothing_upper_size,omitempty"`
	ClothingLowerSize        *string    `protobuf:"bytes,29,opt,name=clothing_lower_size,json=clothingLowerSize,proto3,oneof" json:"clothing_lower_size,omitempty"`
	ShoeSize                 *string    `protobuf:"bytes,30,opt,name=shoe_size,json=shoeSize,proto3,oneof" json:"shoe_size,omitempty"`
	IsFnf                    *bool      `protobuf:"varint,31,opt,name=is_fnf,json=isFnf,proto3,oneof" json:"is_fnf,omitempty"`
	IsBad                    *bool      `protobuf:"varint,32,opt,name=is_bad,json=isBad,proto3,oneof" json:"is_bad,omitempty"`
	IsStylist                *bool      `protobuf:"varint,33,opt,name=is_stylist,json=isStylist,proto3,oneof" json:"is_stylist,omitempty"`
	IsBuyingWomenProducts    *bool      `protobuf:"varint,34,opt,name=is_buying_women_products,json=isBuyingWomenProducts,proto3,oneof" json:"is_buying_women_products,omitempty"`
	IsBuyingMenProducts      *bool      `protobuf:"varint,35,opt,name=is_buying_men_products,json=isBuyingMenProducts,proto3,oneof" json:"is_buying_men_products,omitempty"`
	IsPersonalPolicyAccepted *bool      `protobuf:"varint,36,opt,name=is_personal_policy_accepted,json=isPersonalPolicyAccepted,proto3,oneof" json:"is_personal_policy_accepted,omitempty"`
	Timezone                 *string    `protobuf:"bytes,37,opt,name=timezone,proto3,oneof" json:"timezone,omitempty"`
	Facebook                 *string    `protobuf:"bytes,38,opt,name=facebook,proto3,oneof" json:"facebook,omitempty"`
	Instagram                *string    `protobuf:"bytes,39,opt,name=instagram,proto3,oneof" json:"instagram,omitempty"`
	Telegram                 *string    `protobuf:"bytes,40,opt,name=telegram,proto3,oneof" json:"telegram,omitempty"`
	Vk                       *string    `protobuf:"bytes,41,opt,name=vk,proto3,oneof" json:"vk,omitempty"`
	Whatsapp                 *string    `protobuf:"bytes,42,opt,name=whatsapp,proto3,oneof" json:"whatsapp,omitempty"`
	Tags                     []string   `protobuf:"bytes,43,rep,name=tags,proto3" json:"tags,omitempty"`
	Comment                  *string    `protobuf:"bytes,44,opt,name=comment,proto3,oneof" json:"comment,omitempty"`
	CommunicationChannel     *string    `protobuf:"bytes,45,opt,name=communication_channel,json=communicationChannel,proto3,oneof" json:"communication_channel,omitempty"`
	CommunicationTime        *string    `protobuf:"bytes,46,opt,name=communication_time,json=communicationTime,proto3,oneof" json:"communication_time,omitempty"`
	LastCommunication        *string    `protobuf:"bytes,47,opt,name=last_communication,json=lastCommunication,proto3,oneof" json:"last_communication,omitempty"`
	Brands                   *string    `protobuf:"bytes,48,opt,name=brands,proto3,oneof" json:"brands,omitempty"`
	DoNotPropose             *string    `protobuf:"bytes,49,opt,name=do_not_propose,json=doNotPropose,proto3,oneof" json:"do_not_propose,omitempty"`
	Family                   *string    `protobuf:"bytes,50,opt,name=family,proto3,oneof" json:"family,omitempty"`
	Hobbies                  *string    `protobuf:"bytes,51,opt,name=hobbies,proto3,oneof" json:"hobbies,omitempty"`
	ImportantDates           *string    `protobuf:"bytes,52,opt,name=important_dates,json=importantDates,proto3,oneof" json:"important_dates,omitempty"`
	KindFoActivity           *string    `protobuf:"bytes,53,opt,name=kind_fo_activity,json=kindFoActivity,proto3,oneof" json:"kind_fo_activity,omitempty"`
	OnlineExperience         *string    `protobuf:"bytes,54,opt,name=online_experience,json=onlineExperience,proto3,oneof" json:"online_experience,omitempty"`
	PersonalAssistant        *string    `protobuf:"bytes,55,opt,name=personal_assistant,json=personalAssistant,proto3,oneof" json:"personal_assistant,omitempty"`
	Preferences              *string    `protobuf:"bytes,56,opt,name=preferences,proto3,oneof" json:"preferences,omitempty"`
	Addresses                []*Address `protobuf:"bytes,57,rep,name=addresses,proto3" json:"addresses,omitempty"`
}
...
type Address struct {
	...
	AddressSource    string `protobuf:"bytes,17,opt,name=address_source,json=addressSource,proto3" json:"address_source,omitempty"`
...
func (x *Address) GetAddressSource() string {
	if x != nil {
...
func (x *GetListFilters) GetCountry() string {
	if x != nil && x.Country != nil {
		return *x.Country
	}
	return ""
...
var file_proto_user_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x8c, 0x06, 0x0a, 0x0c, 0x4d, 0x65, 0x72,
	...
	0x6f, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x88, 0x01, 0x01, 0x12, 0x1d, 0x0a, 0x07, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x72, 0x79, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x48, 0x0a, 0x52, 0x07, 0x63, 0x6f,
	...
	0x0a, 0x5f, 0x73, 0x68, 0x6f, 0x65, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x42, 0x0a, 0x0a, 0x08, 0x5f,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x42, 0x07, 0x0a, 0x05, 0x5f, 0x63, 0x69, 0x74, 0x79,
	0x42, 0x09, 0x0a, 0x07, 0x5f, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x42, 0x09, 0x0a, 0x07, 0x5f,
	0x69, 0x73, 0x5f, 0x76, 0x69, 0x63, 0x42, 0x0f, 0x0a, 0x0d, 0x5f, 0x6d, 0x65, 0x72, 0x67, 0x65,
	0x5f, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0xa7, 0x01, 0x0a, 0x0d, 0x4d, 0x65, 0x72, 0x67,
	...
	0x72, 0x6f, 0x72, 0x73, 0x12, 0x2b, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x17, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x4d, 0x65, 0x72, 0x67, 0x65, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74,
	0x61, 0x22, 0x32, 0x0a, 0x11, 0x4d, 0x65, 0x72, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12, 0x1d, 0x0a, 0x0a, 0x68, 0x69, 0x73, 0x74, 0x6f, 0x72,
	0x79, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x68, 0x69, 0x73, 0x74,
	0x6f, 0x72, 0x79, 0x49, 0x64, 0x22, 0x98, 0x06, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x64, 0x64, 0x6c, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	,
	...
	,
	...
	0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x12, 0x1e,
	0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x75,
	0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0xa8,
	0x16, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1f, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x6e,
	...
	0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x88, 0x01, 0x01, 0x12, 0x22, 0x0a, 0x0a, 0x63, 0x72, 0x65,
	...
	,
	...
	0x72, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x1d, 0x20, 0x01, 0x28, 0x09, 0x48, 0x19, 0x52, 0x11,
	...
	,
	...
	0x6e, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x2e, 0x20,
	0x01, 0x28, 0x09, 0x48, 0x29, 0x52, 0x11, 0x63, 0x6f, 0x6d, 0x6d, 0x75, 0x6e, 0x69, 0x63, 0x61,
	...
	,
	...
	,
	...
	0x63, 0x5f, 0x69, 0x64, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79,
	...
	,
	...
	0x74, 0x72, 0x65, 0x65, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x68, 0x6f, 0x75, 0x73, 0x65, 0x18, 0x09,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x68, 0x6f, 0x75, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x68,
	0x6f, 0x75, 0x73, 0x69, 0x6e, 0x67, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x68, 0x6f,
	0x75, 0x73, 0x69, 0x6e, 0x67, 0x12, 0x1a, 0x0a, 0x08, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x69, 0x6e,
	0x67, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x62, 0x75, 0x69, 0x6c, 0x64, 0x69, 0x6e,
	0x67, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x6e, 0x74, 0x72, 0x61, 0x6e, 0x63, 0x65, 0x18, 0x0c, 0x20,
	...
	,
	...
	0x74, 0x61, 0x22, 0x36, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x42, 0x79, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	...
	0x63, 0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xab, 0x01, 0x0a, 0x0e, 0x47,
	0x65, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x33, 0x0a,
	0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14,
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x47, 0x65, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x73, 0x48, 0x00, 0x52, 0x07, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x88,
	0x01, 0x01, 0x12, 0x30, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1b, 0x0a, 0x06, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x48, 0x01, 0x52, 0x06, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x88, 0x01,
	0x01, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x73, 0x42, 0x09, 0x0a,
	0x07, 0x5f, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x22, 0xce, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74,
	...
	0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55, 0x73, 0x65,
	0x72, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x30, 0x0a, 0x0a, 0x70, 0x61, 0x67, 0x69, 0x6e,
	...
	0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x1f, 0x0a, 0x0d, 0x44, 0x65, 0x6c,
	0x65, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x7b, 0x0a, 0x0e, 0x44, 0x65,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xd1, 0x03, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x4c, 0x69,
	...
	0x54, 0x6f, 0x88, 0x01, 0x01, 0x12, 0x1d, 0x0a, 0x07, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x48, 0x05, 0x52, 0x07, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72,
	0x79, 0x88, 0x01, 0x01, 0x12, 0x1b, 0x0a, 0x06, 0x72, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x18, 0x08,
	...
	,
	...
	0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x12, 0x19, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x03, 0x48, 0x00, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x88, 0x01,
	0x01, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x2a, 0x24, 0x0a, 0x08, 0x55,
	...
	0x01, 0x32, 0xfa, 0x02, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x35, 0x0a, 0x06, 0x43, 0x72,
	...
	0x00, 0x12, 0x2c, 0x0a, 0x06, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x0a, 0x2e, 0x75, 0x73,
	0x65, 0x72, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x1a, 0x14, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x55,
	...
	0x65, 0x72, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x09,
	0x5a, 0x07, 0x67, 0x6f, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_proto_user_proto_goTypes = []interface{}{
	...
	(*GetByTokenRequest)(nil), // 11: user.GetByTokenRequest
	(*GetListRequest)(nil),    // 12: user.GetListRequest
	(*GetListResponse)(nil),   // 13: user.GetListResponse
	(*DeleteRequest)(nil),     // 14: user.DeleteRequest
	(*DeleteResponse)(nil),    // 15: user.DeleteResponse
	(*Error)(nil),             // 16: user.Error
	(*GetListFilters)(nil),    // 17: user.GetListFilters
	(*Pagination)(nil),        // 18: user.Pagination
}
var file_proto_user_proto_depIdxs = []int32{
	16, // 0: user.MergeResponse.errors:type_name -> user.Error
	3,  // 1: user.MergeResponse.data:type_name -> user.MergeResponseData
	16, // 2: user.CreateResponse.errors:type_name -> user.Error
	6,  // 3: user.CreateResponse.data:type_name -> user.User
	7,  // 4: user.User.addresses:type_name -> user.Address
	16, // 5: user.UpdateResponse.errors:type_name -> user.Error
	6,  // 6: user.UpdateResponse.data:type_name -> user.User
	16, // 7: user.GetResponse.errors:type_name -> user.Error
	6,  // 8: user.GetResponse.data:type_name -> user.User
	17, // 9: user.GetListRequest.filters:type_name -> user.GetListFilters
	18, // 10: user.GetListRequest.pagination:type_name -> user.Pagination
	16, // 11: user.GetListResponse.errors:type_name -> user.Error
	6,  // 12: user.GetListResponse.data:type_name -> user.User
	18, // 13: user.GetListResponse.pagination:type_name -> user.Pagination
	16, // 14: user.DeleteResponse.errors:type_name -> user.Error
	...
	9,  // 18: user.user.Get:input_type -> user.GetRequest
	11, // 19: user.user.GetByToken:input_type -> user.GetByTokenRequest
	12, // 20: user.user.GetList:input_type -> user.GetListRequest
	14, // 21: user.user.Delete:input_type -> user.DeleteRequest
	1,  // 22: user.user.Merge:input_type -> user.MergeRequest
	5,  // 23: user.user.Create:output_type -> user.CreateResponse
	8,  // 24: user.user.Update:output_type -> user.UpdateResponse
	10, // 25: user.user.Get:output_type -> user.GetResponse
	10, // 26: user.user.GetByToken:output_type -> user.GetResponse
	13, // 27: user.user.GetList:output_type -> user.GetListResponse
	15, // 28: user.user.Delete:output_type -> user.DeleteResponse
...
func file_proto_user_proto_init() {
	...
	file_proto_user_proto_msgTypes[16].OneofWrappers = []interface{}{}
