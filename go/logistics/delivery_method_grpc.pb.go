...
const (
	DeliveryMethodService_List_FullMethodName    = "/logistics.DeliveryMethodService/List"
	DeliveryMethodService_Create_FullMethodName  = "/logistics.DeliveryMethodService/Create"
	DeliveryMethodService_Get_FullMethodName     = "/logistics.DeliveryMethodService/Get"
	DeliveryMethodService_Update_FullMethodName  = "/logistics.DeliveryMethodService/Update"
	DeliveryMethodService_Delete_FullMethodName  = "/logistics.DeliveryMethodService/Delete"
	DeliveryMethodService_Suggest_FullMethodName = "/logistics.DeliveryMethodService/Suggest"
)
...
type DeliveryMethodServiceClient interface {
	...
	Suggest(ctx context.Context, in *SuggestDeliveryMethodRequest, opts ...grpc.CallOption) (*SuggestDeliveryMethodResponse, error)
}
...
func (c *deliveryMethodServiceClient) List(ctx context.Context, in *ListDeliveryMethodRequest, opts ...grpc.CallOption) (*ListDeliveryMethodResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeliveryMethodService_List_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deliveryMethodServiceClient) Create(ctx context.Context, in *DeliveryMethod, opts ...grpc.CallOption) (*DeliveryMethod, error) {
	...
	err := c.cc.Invoke(ctx, DeliveryMethodService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deliveryMethodServiceClient) Get(ctx context.Context, in *DeliveryMethodId, opts ...grpc.CallOption) (*DeliveryMethod, error) {
	out := new(DeliveryMethod)
	err := c.cc.Invoke(ctx, DeliveryMethodService_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deliveryMethodServiceClient) Update(ctx context.Context, in *DeliveryMethod, opts ...grpc.CallOption) (*DeliveryMethod, error) {
	out := new(DeliveryMethod)
	err := c.cc.Invoke(ctx, DeliveryMethodService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deliveryMethodServiceClient) Delete(ctx context.Context, in *DeliveryMethodId, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, DeliveryMethodService_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deliveryMethodServiceClient) Suggest(ctx context.Context, in *SuggestDeliveryMethodRequest, opts ...grpc.CallOption) (*SuggestDeliveryMethodResponse, error) {
	out := new(SuggestDeliveryMethodResponse)
	err := c.cc.Invoke(ctx, DeliveryMethodService_Suggest_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DeliveryMethodServiceServer interface {
	...
	Suggest(context.Context, *SuggestDeliveryMethodRequest) (*SuggestDeliveryMethodResponse, error)
}
...
func (UnimplementedDeliveryMethodServiceServer) Suggest(context.Context, *SuggestDeliveryMethodRequest) (*SuggestDeliveryMethodResponse, error) {
...
func _DeliveryMethodService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeliveryMethodService_List_FullMethodName,
	}
...
func _DeliveryMethodService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeliveryMethodService_Create_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DeliveryMethodService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeliveryMethodService_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DeliveryMethodService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeliveryMethodService_Update_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DeliveryMethodService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeliveryMethodService_Delete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DeliveryMethodService_Suggest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SuggestDeliveryMethodRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeliveryMethodServiceServer).Suggest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeliveryMethodService_Suggest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeliveryMethodServiceServer).Suggest(ctx, req.(*SuggestDeliveryMethodRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DeliveryMethodService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Suggest",
			Handler:    _DeliveryMethodService_Suggest_Handler,
		},
	},
