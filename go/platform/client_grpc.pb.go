...
const (
	Clients_Create_FullMethodName = "/platform.Clients/Create"
	Clients_Get_FullMethodName    = "/platform.Clients/Get"
	Clients_List_FullMethodName   = "/platform.Clients/List"
	Clients_Update_FullMethodName = "/platform.Clients/Update"
	Clients_Upsert_FullMethodName = "/platform.Clients/Upsert"
	Clients_Delete_FullMethodName = "/platform.Clients/Delete"
)
...
type ClientsClient interface {
	...
	Delete(ctx context.Context, in *ClientId, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *clientsClient) Create(ctx context.Context, in *Client, opts ...grpc.CallOption) (*Client, error) {
	out := new(Client)
...
func (c *clientsClient) Upsert(ctx context.Context, in *Client, opts ...grpc.CallOption) (*Client, error) {
	out := new(Client)
	err := c.cc.Invoke(ctx, Clients_Upsert_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientsClient) Delete(ctx context.Context, in *ClientId, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type ClientsServer interface {
	...
	Delete(context.Context, *ClientId) (*emptypb.Empty, error)
}
...
func (UnimplementedClientsServer) Create(context.Context, *Client) (*Client, error) {
...
func (UnimplementedClientsServer) Delete(context.Context, *ClientId) (*emptypb.Empty, error) {
...
func _Clients_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Clients_Create_FullMethodName,
	}
...
func _Clients_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Clients_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Clients_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Clients_List_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Clients_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Clients_Update_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Clients_Upsert_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Clients_Upsert_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Clients_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Clients_Delete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
