...
const (
	ZoneGroupRestrictionService_List_FullMethodName   = "/logistics.ZoneGroupRestrictionService/List"
	ZoneGroupRestrictionService_Create_FullMethodName = "/logistics.ZoneGroupRestrictionService/Create"
	ZoneGroupRestrictionService_Update_FullMethodName = "/logistics.ZoneGroupRestrictionService/Update"
	ZoneGroupRestrictionService_Get_FullMethodName    = "/logistics.ZoneGroupRestrictionService/Get"
	ZoneGroupRestrictionService_Delete_FullMethodName = "/logistics.ZoneGroupRestrictionService/Delete"
)
...
type ZoneGroupRestrictionServiceClient interface {
	...
	Create(ctx context.Context, in *CreateZoneGroupRestriction, opts ...grpc.CallOption) (*ZoneGroupRestriction, error)
	Update(ctx context.Context, in *UpdateZoneGroupRestriction, opts ...grpc.CallOption) (*ZoneGroupRestriction, error)
...
func (c *zoneGroupRestrictionServiceClient) List(ctx context.Context, in *ListZoneGroupRestrictionRequest, opts ...grpc.CallOption) (*ListZoneGroupRestrictionResponse, error) {
	...
	err := c.cc.Invoke(ctx, ZoneGroupRestrictionService_List_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *zoneGroupRestrictionServiceClient) Create(ctx context.Context, in *CreateZoneGroupRestriction, opts ...grpc.CallOption) (*ZoneGroupRestriction, error) {
	out := new(ZoneGroupRestriction)
	err := c.cc.Invoke(ctx, ZoneGroupRestrictionService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *zoneGroupRestrictionServiceClient) Update(ctx context.Context, in *UpdateZoneGroupRestriction, opts ...grpc.CallOption) (*ZoneGroupRestriction, error) {
	out := new(ZoneGroupRestriction)
	err := c.cc.Invoke(ctx, ZoneGroupRestrictionService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *zoneGroupRestrictionServiceClient) Get(ctx context.Context, in *ZoneGroupRestrictionId, opts ...grpc.CallOption) (*ZoneGroupRestriction, error) {
	out := new(ZoneGroupRestriction)
	err := c.cc.Invoke(ctx, ZoneGroupRestrictionService_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *zoneGroupRestrictionServiceClient) Delete(ctx context.Context, in *ZoneGroupRestrictionId, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, ZoneGroupRestrictionService_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ZoneGroupRestrictionServiceServer interface {
	...
	Create(context.Context, *CreateZoneGroupRestriction) (*ZoneGroupRestriction, error)
	Update(context.Context, *UpdateZoneGroupRestriction) (*ZoneGroupRestriction, error)
...
func (UnimplementedZoneGroupRestrictionServiceServer) Create(context.Context, *CreateZoneGroupRestriction) (*ZoneGroupRestriction, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedZoneGroupRestrictionServiceServer) Update(context.Context, *UpdateZoneGroupRestriction) (*ZoneGroupRestriction, error) {
...
func _ZoneGroupRestrictionService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ZoneGroupRestrictionService_List_FullMethodName,
	}
...
func _ZoneGroupRestrictionService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ZoneGroupRestrictionService_Create_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ZoneGroupRestrictionService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ZoneGroupRestrictionService_Update_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ZoneGroupRestrictionService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ZoneGroupRestrictionService_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ZoneGroupRestrictionService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ZoneGroupRestrictionService_Delete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
