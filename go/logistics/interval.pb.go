...
func (x *GroupsInterval) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GroupsInterval) ProtoMessage() {}

func (x *GroupsInterval) ProtoReflect() protoreflect.Message {
	mi := &file_interval_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GroupsInterval.ProtoReflect.Descriptor instead.
func (*GroupsInterval) Descriptor() ([]byte, []int) {
	return file_interval_proto_rawDescGZIP(), []int{4}
}

func (x *GroupsInterval) GetGroupId() string {
	if x != nil {
		return x.GroupId
	}
	return ""
...
func (x *GroupsInterval) GetIntervals() []*Interval {
	if x != nil {
		return x.Intervals
	}
	return nil
...
var file_interval_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x5e, 0x0a, 0x0e, 0x47, 0x72, 0x6f, 0x75, 0x70,
	0x73, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x12, 0x19, 0x0a, 0x08, 0x67, 0x72, 0x6f,
	0x75, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x67, 0x72, 0x6f,
	0x75, 0x70, 0x49, 0x64, 0x12, 0x31, 0x0a, 0x09, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c,
	0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6c, 0x6f, 0x67, 0x69, 0x73, 0x74,
	0x69, 0x63, 0x73, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x52, 0x09, 0x69, 0x6e,
	0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x73, 0x2a, 0x67, 0x0a, 0x09, 0x44, 0x61, 0x79, 0x4f, 0x66,
...
var file_interval_proto_goTypes = []interface{}{
	...
	(*GroupsInterval)(nil),       // 5: logistics.GroupsInterval
...
var file_interval_proto_depIdxs = []int32{
	...
	2, // 2: logistics.GroupsInterval.intervals:type_name -> logistics.Interval
