...
const (
	GlobalRestrictionsService_List_FullMethodName   = "/logistics.GlobalRestrictionsService/List"
	GlobalRestrictionsService_Create_FullMethodName = "/logistics.GlobalRestrictionsService/Create"
	GlobalRestrictionsService_Update_FullMethodName = "/logistics.GlobalRestrictionsService/Update"
)
...
func (c *globalRestrictionsServiceClient) List(ctx context.Context, in *ListGlobalRestrictionRequest, opts ...grpc.CallOption) (*ListGlobalRestrictionResponse, error) {
	...
	err := c.cc.Invoke(ctx, GlobalRestrictionsService_List_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *globalRestrictionsServiceClient) Create(ctx context.Context, in *UpdateGlobalRestriction, opts ...grpc.CallOption) (*GlobalRestriction, error) {
	...
	err := c.cc.Invoke(ctx, GlobalRestrictionsService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *globalRestrictionsServiceClient) Update(ctx context.Context, in *UpdateGlobalRestriction, opts ...grpc.CallOption) (*GlobalRestriction, error) {
	out := new(GlobalRestriction)
	err := c.cc.Invoke(ctx, GlobalRestrictionsService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GlobalRestrictionsService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GlobalRestrictionsService_List_FullMethodName,
	}
...
func _GlobalRestrictionsService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GlobalRestrictionsService_Create_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _GlobalRestrictionsService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GlobalRestrictionsService_Update_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
