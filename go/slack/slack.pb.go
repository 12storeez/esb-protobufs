...
var file_proto_slack_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x05, 0x73, 0x6c, 0x61, 0x63, 0x6b, 0x22, 0x9e, 0x02, 0x0a, 0x0b, 0x53,
	...
	0x6d, 0x69, 0x6e, 0x67, 0x5f, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x22, 0x9f, 0x01, 0x0a, 0x0c,
	...
	0x65, 0x6e, 0x64, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x46, 0x0a,
	...
	0x6e, 0x65, 0x6c, 0x49, 0x64, 0x22, 0xfb, 0x01, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x65, 0x61, 0x64, 0x49, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x18, 0x03,
	...
	0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x3a, 0x0a, 0x1a, 0x69, 0x73, 0x5f, 0x73, 0x70, 0x6c, 0x69,
	...
	0x74, 0x65, 0x6d, 0x22, 0x8f, 0x01, 0x0a, 0x14, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4d, 0x65,
	...
	0x67, 0x65, 0x32, 0x87, 0x02, 0x0a, 0x05, 0x53, 0x6c, 0x61, 0x63, 0x6b, 0x12, 0x31, 0x0a, 0x04,
	...
	0x6e, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0a, 0x5a, 0x08,
	0x67, 0x6f, 0x2f, 0x73, 0x6c, 0x61, 0x63, 0x6b, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_slack_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_proto_slack_proto_goTypes = []interface{}{
	...
	(*GetMessageLinkRequest)(nil),  // 5: slack.GetMessageLinkRequest
	(*GetMessageLinkResponse)(nil), // 6: slack.GetMessageLinkResponse
	(*GetMessageLinkData)(nil),     // 7: slack.GetMessageLinkData
	(*BaseResponse)(nil),           // 8: slack.BaseResponse
	(*Error)(nil),                  // 9: slack.Error
}
var file_proto_slack_proto_depIdxs = []int32{
	9, // 0: slack.SendResponse.errors:type_name -> slack.Error
	2, // 1: slack.SendResponse.data:type_name -> slack.SendData
	9, // 2: slack.GetMessageLinkResponse.errors:type_name -> slack.Error
	7, // 3: slack.GetMessageLinkResponse.data:type_name -> slack.GetMessageLinkData
	9, // 4: slack.BaseResponse.errors:type_name -> slack.Error
	0, // 5: slack.Slack.Send:input_type -> slack.SendRequest
	3, // 6: slack.Slack.Update:input_type -> slack.UpdateMessageRequest
	4, // 7: slack.Slack.Delete:input_type -> slack.DeleteMessageRequest
	5, // 8: slack.Slack.GetMessageLink:input_type -> slack.GetMessageLinkRequest
	1, // 9: slack.Slack.Send:output_type -> slack.SendResponse
	8, // 10: slack.Slack.Update:output_type -> slack.BaseResponse
	8, // 11: slack.Slack.Delete:output_type -> slack.BaseResponse
	6, // 12: slack.Slack.GetMessageLink:output_type -> slack.GetMessageLinkResponse
