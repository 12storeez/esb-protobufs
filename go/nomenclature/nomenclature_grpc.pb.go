...
const (
	...
	PhotoModelService_SetNull_FullMethodName = "/nomenclature.PhotoModelService/SetNull"
)
...
func (c *photoModelServiceClient) SetNull(ctx context.Context, in *SetNullPhotoModel, opts ...grpc.CallOption) (*GetPhotoModelByIDResponse, error) {
	out := new(GetPhotoModelByIDResponse)
	err := c.cc.Invoke(ctx, PhotoModelService_SetNull_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PhotoModelService_SetNull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PhotoModelService_SetNull_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	...
	DictionarySizeService_SetNull_FullMethodName   = "/nomenclature.DictionarySizeService/SetNull"
)
...
func (c *dictionarySizeServiceClient) SetNull(ctx context.Context, in *SetNullDictionarySize, opts ...grpc.CallOption) (*GetDictionarySizeByGUIDResponse, error) {
	out := new(GetDictionarySizeByGUIDResponse)
	err := c.cc.Invoke(ctx, DictionarySizeService_SetNull_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DictionarySizeService_SetNull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DictionarySizeService_SetNull_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	...
	MaintenanceService_SetNull_FullMethodName                      = "/nomenclature.MaintenanceService/SetNull"
...
func (c *maintenanceServiceClient) SetNull(ctx context.Context, in *SetNullMaintenance, opts ...grpc.CallOption) (*GetMaintenanceByIDResponse, error) {
	out := new(GetMaintenanceByIDResponse)
	err := c.cc.Invoke(ctx, MaintenanceService_SetNull_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MaintenanceService_SetNull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MaintenanceService_SetNull_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	...
	CategoryService_SetNull_FullMethodName                  = "/nomenclature.CategoryService/SetNull"
...
func (c *categoryServiceClient) SetNull(ctx context.Context, in *SetNullCategory, opts ...grpc.CallOption) (*GetCategoryByIDResponse, error) {
	out := new(GetCategoryByIDResponse)
	err := c.cc.Invoke(ctx, CategoryService_SetNull_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _CategoryService_SetNull_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CategoryService_SetNull_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
