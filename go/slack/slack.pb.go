...
func (x *EditMessageRequest) GetChannel() string {
	if x != nil {
		return x.Channel
	}
	return ""
...
func (x *EditMessageRequest) GetThreadId() string {
	if x != nil {
		return x.ThreadId
	}
	return ""
...
func (x *EditMessageRequest) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *EditMessageRequest) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *EditMessageRequest) GetIsSplitByBlocksEnabled() bool {
	if x != nil {
		return x.IsSplitByBlocksEnabled
	}
	return false
...
var file_proto_slack_proto_rawDesc = []byte{
	...
	0x6c, 0x49, 0x64, 0x22, 0xb7, 0x01, 0x0a, 0x12, 0x45, 0x64, 0x69, 0x74, 0x4d, 0x65, 0x73, 0x73,
	...
	0x65, 0x12, 0x3a, 0x0a, 0x1a, 0x69, 0x73, 0x5f, 0x73, 0x70, 0x6c, 0x69, 0x74, 0x5f, 0x62, 0x79,
	...
	0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x64, 0x22, 0x4d, 0x0a,
	...
	0x28, 0x09, 0x52, 0x08, 0x74, 0x68, 0x72, 0x65, 0x61, 0x64, 0x49, 0x64, 0x22, 0x7a, 0x0a, 0x0c,
	...
	0x52, 0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x22, 0x4d, 0x0a, 0x05, 0x45, 0x72, 0x72, 0x6f,
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x3a, 0x0a, 0x05, 0x53, 0x6c, 0x61, 0x63, 0x6b,
	0x12, 0x31, 0x0a, 0x04, 0x53, 0x65, 0x6e, 0x64, 0x12, 0x12, 0x2e, 0x73, 0x6c, 0x61, 0x63, 0x6b,
	0x2e, 0x53, 0x65, 0x6e, 0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x13, 0x2e, 0x73,
	0x6c, 0x61, 0x63, 0x6b, 0x2e, 0x53, 0x65, 0x6e, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x00, 0x42, 0x0a, 0x5a, 0x08, 0x67, 0x6f, 0x2f, 0x73, 0x6c, 0x61, 0x63, 0x6b, 0x62,
...
var file_proto_slack_proto_goTypes = []interface{}{
	...
	(*EditMessageRequest)(nil),   // 3: slack.EditMessageRequest
...
var file_proto_slack_proto_depIdxs = []int32{
	...
	1, // 4: slack.Slack.Send:output_type -> slack.SendResponse
