...
var file_proto_slack_proto_rawDesc = []byte{
	...
	0x73, 0x61, 0x67, 0x65, 0x32, 0xce, 0x02, 0x0a, 0x05, 0x53, 0x6c, 0x61, 0x63, 0x6b, 0x12, 0x31,
	...
	0x65, 0x22, 0x00, 0x28, 0x01, 0x42, 0x0a, 0x5a, 0x08, 0x67, 0x6f, 0x2f, 0x73, 0x6c, 0x61, 0x63,
...
var file_proto_slack_proto_depIdxs = []int32{
	...
	9,  // 3: slack.SendRequest.slack_attachments:type_name -> slack.SlackAttachment
	15, // 4: slack.SendResponse.errors:type_name -> slack.Error
	6,  // 5: slack.SendResponse.data:type_name -> slack.SendData
	7,  // 6: slack.SendData.attachments:type_name -> slack.AttachmentResponse
	4,  // 7: slack.UpdateMessageRequest.attachments:type_name -> slack.Attachment
	9,  // 8: slack.UpdateMessageRequest.slack_attachments:type_name -> slack.SlackAttachment
	15, // 9: slack.GetMessageLinkResponse.errors:type_name -> slack.Error
	13, // 10: slack.GetMessageLinkResponse.data:type_name -> slack.GetMessageLinkData
	15, // 11: slack.BaseResponse.errors:type_name -> slack.Error
	3,  // 12: slack.Slack.Send:input_type -> slack.SendRequest
	8,  // 13: slack.Slack.Update:input_type -> slack.UpdateMessageRequest
	10, // 14: slack.Slack.Delete:input_type -> slack.DeleteMessageRequest
	11, // 15: slack.Slack.GetMessageLink:input_type -> slack.GetMessageLinkRequest
	0,  // 16: slack.Slack.FileUpload:input_type -> slack.FileUploadRequest
	5,  // 17: slack.Slack.Send:output_type -> slack.SendResponse
	14, // 18: slack.Slack.Update:output_type -> slack.BaseResponse
	14, // 19: slack.Slack.Delete:output_type -> slack.BaseResponse
	12, // 20: slack.Slack.GetMessageLink:output_type -> slack.GetMessageLinkResponse
	1,  // 21: slack.Slack.FileUpload:output_type -> slack.FileUploadResponse
