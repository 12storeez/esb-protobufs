...
const (
	TransportCompanyService_List_FullMethodName    = "/logistics.TransportCompanyService/List"
	TransportCompanyService_Create_FullMethodName  = "/logistics.TransportCompanyService/Create"
	TransportCompanyService_Get_FullMethodName     = "/logistics.TransportCompanyService/Get"
	TransportCompanyService_Update_FullMethodName  = "/logistics.TransportCompanyService/Update"
	TransportCompanyService_Delete_FullMethodName  = "/logistics.TransportCompanyService/Delete"
	TransportCompanyService_Suggest_FullMethodName = "/logistics.TransportCompanyService/Suggest"
)
...
func (c *transportCompanyServiceClient) List(ctx context.Context, in *ListTransportCompanyRequest, opts ...grpc.CallOption) (*ListTransportCompanyResponse, error) {
	...
	err := c.cc.Invoke(ctx, TransportCompanyService_List_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transportCompanyServiceClient) Create(ctx context.Context, in *TransportCompany, opts ...grpc.CallOption) (*TransportCompany, error) {
	...
	err := c.cc.Invoke(ctx, TransportCompanyService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transportCompanyServiceClient) Get(ctx context.Context, in *TransportCompanyId, opts ...grpc.CallOption) (*TransportCompany, error) {
	out := new(TransportCompany)
	err := c.cc.Invoke(ctx, TransportCompanyService_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transportCompanyServiceClient) Update(ctx context.Context, in *TransportCompany, opts ...grpc.CallOption) (*TransportCompany, error) {
	out := new(TransportCompany)
	err := c.cc.Invoke(ctx, TransportCompanyService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transportCompanyServiceClient) Delete(ctx context.Context, in *TransportCompanyId, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, TransportCompanyService_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transportCompanyServiceClient) Suggest(ctx context.Context, in *SuggestTransportCompanyRequest, opts ...grpc.CallOption) (*SuggestTransportCompanyResponse, error) {
	...
	err := c.cc.Invoke(ctx, TransportCompanyService_Suggest_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TransportCompanyService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransportCompanyService_List_FullMethodName,
	}
...
func _TransportCompanyService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransportCompanyService_Create_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TransportCompanyService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransportCompanyService_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TransportCompanyService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransportCompanyService_Update_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TransportCompanyService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransportCompanyService_Delete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TransportCompanyService_Suggest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransportCompanyService_Suggest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
