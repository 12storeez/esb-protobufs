...
func (x *DeliveryModeId) Reset() {
	*x = DeliveryModeId{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_logistics_delivery_mode_proto_msgTypes[0]
...
func (*DeliveryModeId) Descriptor() ([]byte, []int) {
	return file_proto_logistics_delivery_mode_proto_rawDescGZIP(), []int{0}
}
...
func (x *DeliveryMode) Reset() {
	*x = DeliveryMode{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_logistics_delivery_mode_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeliveryMode) Descriptor() ([]byte, []int) {
	return file_proto_logistics_delivery_mode_proto_rawDescGZIP(), []int{1}
}
...
func (x *ListDeliveryModeRequest) Reset() {
	*x = ListDeliveryModeRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_logistics_delivery_mode_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListDeliveryModeRequest) Descriptor() ([]byte, []int) {
	return file_proto_logistics_delivery_mode_proto_rawDescGZIP(), []int{2}
}
...
func (x *ListDeliveryModeResponse) Reset() {
	*x = ListDeliveryModeResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_logistics_delivery_mode_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ListDeliveryModeResponse) Descriptor() ([]byte, []int) {
	return file_proto_logistics_delivery_mode_proto_rawDescGZIP(), []int{3}
}
...
var File_proto_logistics_delivery_mode_proto protoreflect.FileDescriptor

var file_proto_logistics_delivery_mode_proto_rawDesc = []byte{
	0x0a, 0x23, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6c, 0x6f, 0x67, 0x69, 0x73, 0x74, 0x69, 0x63,
	0x73, 0x2f, 0x64, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x2e,
...
var (
	file_proto_logistics_delivery_mode_proto_rawDescOnce sync.Once
	file_proto_logistics_delivery_mode_proto_rawDescData = file_proto_logistics_delivery_mode_proto_rawDesc
)

func file_proto_logistics_delivery_mode_proto_rawDescGZIP() []byte {
	file_proto_logistics_delivery_mode_proto_rawDescOnce.Do(func() {
		file_proto_logistics_delivery_mode_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_logistics_delivery_mode_proto_rawDescData)
	})
	return file_proto_logistics_delivery_mode_proto_rawDescData
}

var file_proto_logistics_delivery_mode_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_logistics_delivery_mode_proto_goTypes = []interface{}{
...
var file_proto_logistics_delivery_mode_proto_depIdxs = []int32{
...
func init() { file_proto_logistics_delivery_mode_proto_init() }
func file_proto_logistics_delivery_mode_proto_init() {
	if File_proto_logistics_delivery_mode_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_proto_logistics_delivery_mode_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_logistics_delivery_mode_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_logistics_delivery_mode_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_logistics_delivery_mode_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_logistics_delivery_mode_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_logistics_delivery_mode_proto_goTypes,
		DependencyIndexes: file_proto_logistics_delivery_mode_proto_depIdxs,
		MessageInfos:      file_proto_logistics_delivery_mode_proto_msgTypes,
	}.Build()
	File_proto_logistics_delivery_mode_proto = out.File
	file_proto_logistics_delivery_mode_proto_rawDesc = nil
	file_proto_logistics_delivery_mode_proto_goTypes = nil
	file_proto_logistics_delivery_mode_proto_depIdxs = nil
}
