...
type DeliveryType struct {
	...
	ShippingTime                            string                         `protobuf:"bytes,15,opt,name=shipping_time,json=shippingTime,proto3" json:"shipping_time,omitempty"`
	ConsolidationHours                      int32                          `protobuf:"varint,16,opt,name=consolidation_hours,json=consolidationHours,proto3" json:"consolidation_hours,omitempty"`
	GapHours                                int32                          `protobuf:"varint,17,opt,name=gap_hours,json=gapHours,proto3" json:"gap_hours,omitempty"`
	PriorityCoefficient                     float32                        `protobuf:"fixed32,18,opt,name=priority_coefficient,json=priorityCoefficient,proto3" json:"priority_coefficient,omitempty"`
	MaxDaysCoefficient                      float32                        `protobuf:"fixed32,19,opt,name=max_days_coefficient,json=maxDaysCoefficient,proto3" json:"max_days_coefficient,omitempty"`
	TariffCoefficient                       float32                        `protobuf:"fixed32,20,opt,name=tariff_coefficient,json=tariffCoefficient,proto3" json:"tariff_coefficient,omitempty"`
	WinnerPercent                           int32                          `protobuf:"varint,21,opt,name=winner_percent,json=winnerPercent,proto3" json:"winner_percent,omitempty"`
	MaxPrice                                int32                          `protobuf:"varint,22,opt,name=max_price,json=maxPrice,proto3" json:"max_price,omitempty"`
	RestrictionByPriceIsActive              bool                           `protobuf:"varint,23,opt,name=restriction_by_price_is_active,json=restrictionByPriceIsActive,proto3" json:"restriction_by_price_is_active,omitempty"`
	RestrictionByPriceMessage               *Message                       `protobuf:"bytes,24,opt,name=restriction_by_price_message,json=restrictionByPriceMessage,proto3" json:"restriction_by_price_message,omitempty"`
	RestrictionByPricePopup                 *Popup                         `protobuf:"bytes,25,opt,name=restriction_by_price_popup,json=restrictionByPricePopup,proto3" json:"restriction_by_price_popup,omitempty"`
	MaxQuantity                             int32                          `protobuf:"varint,26,opt,name=max_quantity,json=maxQuantity,proto3" json:"max_quantity,omitempty"`
	RestrictionByQuantityIsActive           bool                           `protobuf:"varint,27,opt,name=restriction_by_quantity_is_active,json=restrictionByQuantityIsActive,proto3" json:"restriction_by_quantity_is_active,omitempty"`
	RestrictionByQuantityMessage            *Message                       `protobuf:"bytes,28,opt,name=restriction_by_quantity_message,json=restrictionByQuantityMessage,proto3" json:"restriction_by_quantity_message,omitempty"`
	RestrictionByQuantityPopup              *Popup                         `protobuf:"bytes,29,opt,name=restriction_by_quantity_popup,json=restrictionByQuantityPopup,proto3" json:"restriction_by_quantity_popup,omitempty"`
	MaxQuantityPerArticle                   int32                          `protobuf:"varint,30,opt,name=max_quantity_per_article,json=maxQuantityPerArticle,proto3" json:"max_quantity_per_article,omitempty"`
	RestrictionByQuantityPerArticleIsActive bool                           `protobuf:"varint,31,opt,name=restriction_by_quantity_per_article_is_active,json=restrictionByQuantityPerArticleIsActive,proto3" json:"restriction_by_quantity_per_article_is_active,omitempty"`
	RestrictionByQuantityPerArticleMessage  *Message                       `protobuf:"bytes,32,opt,name=restriction_by_quantity_per_article_message,json=restrictionByQuantityPerArticleMessage,proto3" json:"restriction_by_quantity_per_article_message,omitempty"`
	RestrictionByQuantityPerArticlePopup    *Popup                         `protobuf:"bytes,33,opt,name=restriction_by_quantity_per_article_popup,json=restrictionByQuantityPerArticlePopup,proto3" json:"restriction_by_quantity_per_article_popup,omitempty"`
	IsVisibleWhileRestricted                bool                           `protobuf:"varint,34,opt,name=is_visible_while_restricted,json=isVisibleWhileRestricted,proto3" json:"is_visible_while_restricted,omitempty"`
	...
	PaymentMethodToDeliveryType             []*PaymentMethodToDeliveryType `protobuf:"bytes,38,rep,name=payment_method_to_delivery_type,json=paymentMethodToDeliveryType,proto3" json:"payment_method_to_delivery_type,omitempty"`
	CategoryDeliveryTypeRestrictions        []*CategoryRestriction         `protobuf:"bytes,39,rep,name=category_delivery_type_restrictions,json=categoryDeliveryTypeRestrictions,proto3" json:"category_delivery_type_restrictions,omitempty"`
	Intervals                               []*Interval                    `protobuf:"bytes,40,rep,name=intervals,proto3" json:"intervals,omitempty"`
}
...
func (x *DeliveryType) GetShippingTime() string {
	if x != nil {
...
type UpdateDeliveryType struct {
	...
	MaxPrice                                 int32                                `protobuf:"varint,22,opt,name=max_price,json=maxPrice,proto3" json:"max_price,omitempty"`
	RestrictionByPriceIsActive               bool                                 `protobuf:"varint,23,opt,name=restriction_by_price_is_active,json=restrictionByPriceIsActive,proto3" json:"restriction_by_price_is_active,omitempty"`
	RestrictionByPriceMessageId              int32                                `protobuf:"varint,24,opt,name=restriction_by_price_message_id,json=restrictionByPriceMessageId,proto3" json:"restriction_by_price_message_id,omitempty"`
	RestrictionByPricePopupId                int32                                `protobuf:"varint,25,opt,name=restriction_by_price_popup_id,json=restrictionByPricePopupId,proto3" json:"restriction_by_price_popup_id,omitempty"`
	MaxQuantity                              int32                                `protobuf:"varint,26,opt,name=max_quantity,json=maxQuantity,proto3" json:"max_quantity,omitempty"`
	RestrictionByQuantityIsActive            bool                                 `protobuf:"varint,27,opt,name=restriction_by_quantity_is_active,json=restrictionByQuantityIsActive,proto3" json:"restriction_by_quantity_is_active,omitempty"`
	RestrictionByQuantityMessageId           int32                                `protobuf:"varint,28,opt,name=restriction_by_quantity_message_id,json=restrictionByQuantityMessageId,proto3" json:"restriction_by_quantity_message_id,omitempty"`
	RestrictionByQuantityPopupId             int32                                `protobuf:"varint,29,opt,name=restriction_by_quantity_popup_id,json=restrictionByQuantityPopupId,proto3" json:"restriction_by_quantity_popup_id,omitempty"`
	MaxQuantityPerArticle                    int32                                `protobuf:"varint,30,opt,name=max_quantity_per_article,json=maxQuantityPerArticle,proto3" json:"max_quantity_per_article,omitempty"`
	RestrictionByQuantityPerArticleIsActive  bool                                 `protobuf:"varint,31,opt,name=restriction_by_quantity_per_article_is_active,json=restrictionByQuantityPerArticleIsActive,proto3" json:"restriction_by_quantity_per_article_is_active,omitempty"`
	RestrictionByQuantityPerArticleMessageId int32                                `protobuf:"varint,32,opt,name=restriction_by_quantity_per_article_message_id,json=restrictionByQuantityPerArticleMessageId,proto3" json:"restriction_by_quantity_per_article_message_id,omitempty"`
	RestrictionByQuantityPerArticlePopupId   int32                                `protobuf:"varint,33,opt,name=restriction_by_quantity_per_article_popup_id,json=restrictionByQuantityPerArticlePopupId,proto3" json:"restriction_by_quantity_per_article_popup_id,omitempty"`
	IsVisibleWhileRestricted                 bool                                 `protobuf:"varint,34,opt,name=is_visible_while_restricted,json=isVisibleWhileRestricted,proto3" json:"is_visible_while_restricted,omitempty"`
	IsActive                                 bool                                 `protobuf:"varint,35,opt,name=is_active,json=isActive,proto3" json:"is_active,omitempty"`
	PaymentMethodToDeliveryType              []*UpdatePaymentMethodToDeliveryType `protobuf:"bytes,36,rep,name=payment_method_to_delivery_type,json=paymentMethodToDeliveryType,proto3" json:"payment_method_to_delivery_type,omitempty"`
	CategoryDeliveryTypeRestrictions         []*UpdateCategoryRestriction         `protobuf:"bytes,37,rep,name=category_delivery_type_restrictions,json=categoryDeliveryTypeRestrictions,proto3" json:"category_delivery_type_restrictions,omitempty"`
	Intervals                                []*Interval                          `protobuf:"bytes,38,rep,name=intervals,proto3" json:"intervals,omitempty"`
}
...
func (x *UpdateDeliveryType) GetShippingTime() string {
	if x != nil {
		return x.ShippingTime
	}
	return ""
...
var file_delivery_type_proto_rawDesc = []byte{
	...
	0xa2, 0x01, 0x0a, 0x19, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x22, 0x92, 0x01, 0x0a, 0x11, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72,
	0x79, 0x54, 0x79, 0x70, 0x65, 0x53, 0x68, 0x6f, 0x72, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x73, 0x0a, 0x17, 0x4c, 0x69, 0x73,
	0x74, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x54, 0x79, 0x70, 0x65, 0x52, 0x65, 0x71,
	...
	,
	...
	,
	...
	0x65, 0x18, 0x1f, 0x20, 0x01, 0x28, 0x08, 0x52, 0x27, 0x72, 0x65, 0x73, 0x74, 0x72, 0x69, 0x63,
	...
	0x12, 0x6f, 0x0a, 0x2b, 0x72, 0x65, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
	0x62, 0x79, 0x5f, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x5f, 0x70, 0x65, 0x72, 0x5f,
	0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x5f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18,
	0x20, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x6c, 0x6f, 0x67, 0x69, 0x73, 0x74, 0x69, 0x63,
	0x73, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x26, 0x72, 0x65, 0x73, 0x74, 0x72,
	...
	,
	...
	0x18, 0x28, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x6c, 0x6f, 0x67, 0x69, 0x73, 0x74, 0x69,
	0x63, 0x73, 0x2e, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x52, 0x09, 0x69, 0x6e, 0x74,
	0x65, 0x72, 0x76, 0x61, 0x6c, 0x73, 0x22, 0x87, 0x02, 0x0a, 0x13, 0x43, 0x61, 0x74, 0x65, 0x67,
	0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0e,
	...
	0x32, 0x13, 0x2e, 0x6c, 0x6f, 0x67, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x2e, 0x43, 0x61, 0x74,
	...
	0x32, 0x12, 0x2e, 0x6c, 0x6f, 0x67, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x2e, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x26, 0x0a,
	0x05, 0x70, 0x6f, 0x70, 0x75, 0x70, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6c,
	0x6f, 0x67, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x2e, 0x50, 0x6f, 0x70, 0x75, 0x70, 0x52, 0x05,
	0x70, 0x6f, 0x70, 0x75, 0x70, 0x12, 0x1b, 0x0a, 0x09, 0x69, 0x73, 0x5f, 0x61, 0x63, 0x74, 0x69,
	...
	0x22, 0xe6, 0x02, 0x0a, 0x1b, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x74, 0x68,
	0x6f, 0x64, 0x54, 0x6f, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x54, 0x79, 0x70, 0x65,
	0x12, 0x3f, 0x0a, 0x0e, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6d, 0x65, 0x74, 0x68,
	0x6f, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6c, 0x6f, 0x67, 0x69, 0x73,
	...
	,
	...
	0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x21, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4d,
	0x65, 0x74, 0x68, 0x6f, 0x64, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73,
	0x74, 0x72, 0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0xdc, 0x01, 0x0a, 0x20, 0x50, 0x61,
	0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x43, 0x61, 0x74, 0x65, 0x67,
	0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x2f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x72, 0x79, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x70, 0x6f, 0x70, 0x75, 0x70, 0x5f, 0x69, 0x64,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x70, 0x6f, 0x70, 0x75, 0x70, 0x49, 0x64, 0x12,
	0x1b, 0x0a, 0x09, 0x69, 0x73, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x08, 0x69, 0x73, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x22, 0x4a, 0x0a, 0x1a,
	...
	0x52, 0x06, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x22, 0x56, 0x0a, 0x13, 0x53, 0x75, 0x67, 0x67,
	0x65, 0x73, 0x74, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x54, 0x79, 0x70, 0x65, 0x12,
	0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x12,
	...
	0x22, 0x6d, 0x0a, 0x1b, 0x53, 0x75, 0x67, 0x67, 0x65, 0x73, 0x74, 0x44, 0x65, 0x6c, 0x69, 0x76,
	0x65, 0x72, 0x79, 0x54, 0x79, 0x70, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x38, 0x0a, 0x07, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x1e, 0x2e, 0x6c, 0x6f, 0x67, 0x69, 0x73, 0x74, 0x69, 0x63, 0x73, 0x2e, 0x53, 0x75, 0x67,
	...
	0x53, 0x68, 0x6f, 0x72, 0x74, 0x22, 0x20, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1a, 0x22, 0x15, 0x2f,
	0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x64, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x2d,
	0x74, 0x79, 0x70, 0x65, 0x3a, 0x01, 0x2a, 0x12, 0x5d, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x19,
	...
	0x65, 0x72, 0x79, 0x2d, 0x74, 0x79, 0x70, 0x65, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x3a, 0x01, 0x2a,
...
var file_delivery_type_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_delivery_type_proto_goTypes = []interface{}{
	...
	(*SuggestDeliveryTypeRequest)(nil),             // 13: logistics.SuggestDeliveryTypeRequest
	(*SuggestDeliveryType)(nil),                    // 14: logistics.SuggestDeliveryType
	(*SuggestDeliveryTypeResponse)(nil),            // 15: logistics.SuggestDeliveryTypeResponse
	(*TransportCompanyMode)(nil),                   // 16: logistics.TransportCompanyMode
	(*ZoneGroup)(nil),                              // 17: logistics.ZoneGroup
	(*Popup)(nil),                                  // 18: logistics.Popup
	(*Message)(nil),                                // 19: logistics.Message
	(*Interval)(nil),                               // 20: logistics.Interval
	(*Category)(nil),                               // 21: logistics.Category
	(*PaymentMethod)(nil),                          // 22: logistics.PaymentMethod
...
var file_delivery_type_proto_depIdxs = []int32{
	...
	16, // 1: logistics.DeliveryType.transport_company_mode:type_name -> logistics.TransportCompanyMode
	17, // 2: logistics.DeliveryType.zone_group:type_name -> logistics.ZoneGroup
	18, // 3: logistics.DeliveryType.popup:type_name -> logistics.Popup
	19, // 4: logistics.DeliveryType.restriction_by_price_message:type_name -> logistics.Message
	18, // 5: logistics.DeliveryType.restriction_by_price_popup:type_name -> logistics.Popup
	19, // 6: logistics.DeliveryType.restriction_by_quantity_message:type_name -> logistics.Message
	18, // 7: logistics.DeliveryType.restriction_by_quantity_popup:type_name -> logistics.Popup
	19, // 8: logistics.DeliveryType.restriction_by_quantity_per_article_message:type_name -> logistics.Message
	18, // 9: logistics.DeliveryType.restriction_by_quantity_per_article_popup:type_name -> logistics.Popup
	...
	20, // 12: logistics.DeliveryType.intervals:type_name -> logistics.Interval
	21, // 13: logistics.CategoryRestriction.category:type_name -> logistics.Category
	19, // 14: logistics.CategoryRestriction.message:type_name -> logistics.Message
	18, // 15: logistics.CategoryRestriction.popup:type_name -> logistics.Popup
	22, // 16: logistics.PaymentMethodToDeliveryType.payment_method:type_name -> logistics.PaymentMethod
	19, // 17: logistics.PaymentMethodToDeliveryType.message:type_name -> logistics.Message
	...
	21, // 19: logistics.PaymentMethodCategoryRestriction.category:type_name -> logistics.Category
	19, // 20: logistics.PaymentMethodCategoryRestriction.message:type_name -> logistics.Message
	...
	20, // 23: logistics.UpdateDeliveryType.intervals:type_name -> logistics.Interval
	...
	14, // 25: logistics.SuggestDeliveryTypeResponse.results:type_name -> logistics.SuggestDeliveryType
	3,  // 26: logistics.DeliveryTypeService.List:input_type -> logistics.ListDeliveryTypeRequest
	1,  // 27: logistics.DeliveryTypeService.Create:input_type -> logistics.CreateDeliveryTypeRequest
	0,  // 28: logistics.DeliveryTypeService.Get:input_type -> logistics.DeliveryTypeId
	0,  // 29: logistics.DeliveryTypeService.Delete:input_type -> logistics.DeliveryTypeId
	9,  // 30: logistics.DeliveryTypeService.Update:input_type -> logistics.UpdateDeliveryType
	13, // 31: logistics.DeliveryTypeService.Suggest:input_type -> logistics.SuggestDeliveryTypeRequest
	4,  // 32: logistics.DeliveryTypeService.List:output_type -> logistics.ListDeliveryTypeResponse
	2,  // 33: logistics.DeliveryTypeService.Create:output_type -> logistics.DeliveryTypeShort
	5,  // 34: logistics.DeliveryTypeService.Get:output_type -> logistics.DeliveryType
	23, // 35: logistics.DeliveryTypeService.Delete:output_type -> google.protobuf.Empty
	5,  // 36: logistics.DeliveryTypeService.Update:output_type -> logistics.DeliveryType
	15, // 37: logistics.DeliveryTypeService.Suggest:output_type -> logistics.SuggestDeliveryTypeResponse
