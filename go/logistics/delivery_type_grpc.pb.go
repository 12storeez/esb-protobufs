...
const (
	DeliveryTypeService_List_FullMethodName    = "/logistics.DeliveryTypeService/List"
	DeliveryTypeService_Create_FullMethodName  = "/logistics.DeliveryTypeService/Create"
	DeliveryTypeService_Get_FullMethodName     = "/logistics.DeliveryTypeService/Get"
	DeliveryTypeService_Delete_FullMethodName  = "/logistics.DeliveryTypeService/Delete"
	DeliveryTypeService_Update_FullMethodName  = "/logistics.DeliveryTypeService/Update"
	DeliveryTypeService_Suggest_FullMethodName = "/logistics.DeliveryTypeService/Suggest"
)
...
func (c *deliveryTypeServiceClient) List(ctx context.Context, in *ListDeliveryTypeRequest, opts ...grpc.CallOption) (*ListDeliveryTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeliveryTypeService_List_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deliveryTypeServiceClient) Create(ctx context.Context, in *CreateDeliveryTypeRequest, opts ...grpc.CallOption) (*DeliveryTypeShort, error) {
	...
	err := c.cc.Invoke(ctx, DeliveryTypeService_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deliveryTypeServiceClient) Get(ctx context.Context, in *DeliveryTypeId, opts ...grpc.CallOption) (*DeliveryType, error) {
	...
	err := c.cc.Invoke(ctx, DeliveryTypeService_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deliveryTypeServiceClient) Delete(ctx context.Context, in *DeliveryTypeId, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, DeliveryTypeService_Delete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deliveryTypeServiceClient) Update(ctx context.Context, in *UpdateDeliveryType, opts ...grpc.CallOption) (*DeliveryType, error) {
	out := new(DeliveryType)
	err := c.cc.Invoke(ctx, DeliveryTypeService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *deliveryTypeServiceClient) Suggest(ctx context.Context, in *SuggestDeliveryTypeRequest, opts ...grpc.CallOption) (*SuggestDeliveryTypeResponse, error) {
	...
	err := c.cc.Invoke(ctx, DeliveryTypeService_Suggest_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DeliveryTypeService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeliveryTypeService_List_FullMethodName,
	}
...
func _DeliveryTypeService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeliveryTypeService_Create_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DeliveryTypeService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeliveryTypeService_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DeliveryTypeService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeliveryTypeService_Delete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DeliveryTypeService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeliveryTypeService_Update_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DeliveryTypeService_Suggest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SuggestDeliveryTypeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeliveryTypeServiceServer).Suggest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeliveryTypeService_Suggest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeliveryTypeServiceServer).Suggest(ctx, req.(*SuggestDeliveryTypeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DeliveryTypeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Suggest",
			Handler:    _DeliveryTypeService_Suggest_Handler,
		},
	},
