...
type ZoneToGeoId struct {
	...
	GeoId int32 `protobuf:"varint,1,opt,name=geo_id,json=geoId,proto3" json:"geo_id,omitempty"`
}
...
func (x *ZoneToGeoId) GetGeoId() int32 {
	if x != nil {
		return x.GeoId
	}
	return 0
...
var file_zone_to_geo_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x67, 0x65, 0x6f, 0x49, 0x64, 0x22, 0xdf, 0x01, 0x0a, 0x09,
